...
After reaching a maximum sample size of 100 analyses from papers with both code and data available, we will stop.
...
If we are unable to find a minimum of 30 papers with both code and data available, we will randomly add additional papers from journals that had > 30 relevant papers available until we reach this threshold.
